...
<head>
    ...
    <title>Register - Pulse Community</title>
...
<body style="display: flex; align-items: center; justify-content: center; min-height: 100vh;">
    ...
    <div class="modal-card" style="transform: none; max-width: 440px;">
        <div style="text-align: center; margin-bottom: 1.5rem;">
            ...
            <p style="color: var(--text-muted); font-size: 0.85rem; margin-top: 0.5rem;">Create a new member account</p>
        </div>
        
        <form id="standalone-register-form">
            <div style="margin-bottom: 1rem;">
                <label style="display: block; font-size: 0.8rem; margin-bottom: 0.3rem;">Username</label>
                <input type="text" name="username" required style="width: 100%; padding: 0.65rem; background: var(--bg-input); border: 1px solid var(--border-color); border-radius: var(--radius-sm); color: white;">
            </div>
            <div style="margin-bottom: 1rem;">
                <label style="display: block; font-size: 0.8rem; margin-bottom: 0.3rem;">Email Address</label>
                <input type="email" name="email" required style="width: 100%; padding: 0.65rem; background: var(--bg-input); border: 1px solid var(--border-color); border-radius: var(--radius-sm); color: white;">
            </div>
    ...
    <script>
        document.getElementById('standalone-register-form').addEventListener('submit', async (e) => {
            e.preventDefault();
